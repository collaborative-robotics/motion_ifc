...
//    boost::shared_ptr<FcnHandleBase> servo_cv = robotCmd.get_method_by_name("servo_cv");
//    boost::shared_ptr<FcnHandleBase> measured_cf = robotState.get_method_by_name("measured_cf");
